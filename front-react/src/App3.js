...
function Login() {
  return (
    <form action="/login" method="POST">
      <p>아이디<br/><input type="text" name="userid"></input></p>
      <p>패스워드<br/><input  type="text" name="userpwd"></input></p>
      <button type='submit' value="Login">로그인</button>&nbsp;&nbsp;<button>회원가입</button>
    </form>
  )
}
